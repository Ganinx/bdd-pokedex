    ...
    <div class="row justify-content-center">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="number" name="pv" value="<?php displayForValue("pv")?>" class="form-control <?php displayValidationBootstrapClass($errors,"pv") ?>">
                <?php displayFormError("pv",$errors)?>
            </div>
            <div class="form-group">
                <label for="attaque">Attaque</label>
                <input type="number" name="attaque" value="<?php displayForValue("attaque")?>" class="form-control <?php displayValidationBootstrapClass($errors,"attaque") ?>">
                <?php displayFormError("attaque",$errors)?>
            </div>
            <div class="form-group">
                <label for="defense">Defense</label>
                <input type="number" name="defense" value="<?php displayForValue("defense")?>" class="form-control <?php displayValidationBootstrapClass($errors,"defense") ?>">
                <?php displayFormError("defense",$errors)?>
            </div>
            <div class="form-group">
                <label for="vitesse">Vitesse</label>
                <input type="number" name="vitesse" value="<?php displayForValue("vitesse")?>" class="form-control <?php displayValidationBootstrapClass($errors,"vitesse") ?>">
                <?php displayFormError("vitesse",$errors)?>
            </div>
            <div class="form-group">
                <label for="special">Spécial</label>
                <input type="number" name="special" value="<?php displayForValue("special")?>" class="form-control <?php displayValidationBootstrapClass($errors,"special") ?>">
                <?php displayFormError("special",$errors)?>
            </div>
            <div class="form-group">
